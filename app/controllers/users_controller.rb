class UsersController < ApplicationController
  ...
  def withdraw
    ...
    if amount <= 0
      ...
      if transaction.save
        flash[:notice] = "Your withdraw request was created"
      else
        flash[:alert] = "Cannot create your withdrawal request"
      end
    end
